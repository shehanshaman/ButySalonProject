...
public class DetailForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!userName.getText().isEmpty() && password.getPassword().length != 0) {
            ...
            try {
                if (details.addFunctionalDetail(userName.getText().trim(), String.valueOf(password.getPassword()))) {
                    JOptionPane.showMessageDialog(null, "Adding is successed", null, JOptionPane.INFORMATION_MESSAGE);
                    try {
                        UserControllerByChule.getCountOfUsers();//set user count to the load Counter
                    ...
                    JOptionPane.showMessageDialog(null, "Adding is not successed", null, JOptionPane.ERROR_MESSAGE);
                    this.dispose();
                    System.exit(0);
                }
            } catch (IOException ex) {
