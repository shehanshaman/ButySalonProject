...
public class DailyReport extends javax.swing.JDialog {
    ...
    public DailyReport(java.awt.Frame parent, boolean modal, String date) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        ...
        try {
            ArrayList<OrderDetail> allOrderedItemsByDate = controller.getAllOrderedItemsByDate(date);
            ...
            totalDiscounts.setText(String.valueOf(controller.getDiscountsByDate(date)));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Daily Summery");

        dateLabel.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        dateLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        dateLabel.setText("sas");
        ...
        cart.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ITEMCODE", "NAME", "BUYINGPRICE", "SELLINGPRICE", "Noumber", "EACHTOTAL"
            }
        ) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(210, 210, 210)
                                .addComponent(dateLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void showButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showButtonActionPerformed
        new ViewDailyOrders(null, true, dateLabel.getText().trim()).setVisible(true);
