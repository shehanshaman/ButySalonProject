 ...
 */
public class AdminLogInToSystem extends javax.swing.JFrame {

    /**
     * Creates new form LogInToSystem
     */
    public AdminLogInToSystem() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminLogInToSystem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminLogInToSystem().setVisible(true);
            }
        });
    }
