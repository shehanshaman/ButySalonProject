 ...
 */
public class AdminLogInToAccount extends javax.swing.JFrame {

    /**
     * Creates new form LogInToSystem
     */
    public AdminLogInToAccount() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminLogInToAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminLogInToAccount().setVisible(true);
            }
        });
    }
