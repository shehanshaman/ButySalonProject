 ...
 */
public class AdminLogInToReport extends javax.swing.JFrame {

    /**
     * Creates new form LogInToSystem
     */
    public AdminLogInToReport() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminLogInToReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminLogInToReport().setVisible(true);
            }
        });
    }
