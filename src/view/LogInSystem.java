...
public class LogInSystem extends javax.swing.JDialog {
    ...
    public LogInSystem(HomePage page, NewOrderPenal penal, Frame parent, boolean model) {
        super(parent, model);
        initComponents();
        setSize(730, 460);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        messageLabel.setBounds(130, 380, 400, 30);
        ...
        if (userNameTxt.getText() != null && passwordTxt.getPassword().length != 0) {
            ...
            try {
                if (userController.verifyUser(userNameTxt.getText(), String.valueOf(passwordTxt.getPassword()))) {
                    ...
                    page.setUser(searchUser.getUserName());
                    page.setUserType(searchUser.getType());
                    penal.setUserName(searchUser.getUserName());
                    this.dispose();
                } else {
